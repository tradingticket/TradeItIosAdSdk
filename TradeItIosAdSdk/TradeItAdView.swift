...
public class TradeItAdView: UIView {
    ...
    public func configure(withAdType adType: String, broker: String?, heightConstraint: NSLayoutConstraint?) {
    ...
    public func configure(withAdType adType: String) {
        configure(withAdType: adType, broker: nil, heightConstraint: nil)
    }

    public func configure(withAdType adType: String, broker: String) {
        configure(withAdType: adType, broker: broker, heightConstraint: nil)
    }

    public func configure(withAdType adType: String, heightConstraint: NSLayoutConstraint?) {
        configure(withAdType: adType, broker: nil, heightConstraint: heightConstraint)
    }
